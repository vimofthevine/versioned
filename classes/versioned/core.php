...
abstract class Versioned_Core {
	 ...
	 * @return  array    adds and deletions
	 */
	 ...
	 * @param   array   adds and deletions
	 * @param   bool    whether the original string is the old or new string
	 * @return  string
	 */
	 ...
	 * @param   string  the old string
	 * @param   string  the new string
	 * @return  array   left and right arrays
	 */
